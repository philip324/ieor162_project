vdccost = 'DataSet2/Results_Template_1_VDC_DataSet2.csv';
shipdetails = 'DataSet2/Results_Template_4_ShipDetails_DataSet2.csv';
leadtime = 'DataSet2/Results_Template_6_Leadtime_DataSet2.csv';
